defmodule Explorer.Chain.Supply.ProofOfAuthority do
  @moduledoc """
  Defines the supply API for calculating supply for ECH.

  ECH launched on Dec 15, 2017 with 252,460,800 coins with 20% reserved for
  ...
  See https://github.com/poanetwork/wiki/wiki/ECH-Token-Supply for more
  information.
  """
